...
(function(global, $, UI){
    ...
    dropdown.on("click", ".uk-datepicker-next, .uk-datepicker-previous, [data-date]", function(e){
        ...
        if(ele.is('[data-date]')) {
            ...
            /* Modified: added support for div and label */
            var tagName = active.element.prop('tagName').toLowerCase();
            if (tagName == 'div' || tagName == 'label') {
                active.element.text(moment(ele.data("date")).format(active.options.format));
            }
